...
OUT_DIR="scenarios/joinmarket/experiments/experiments_3_maker_increas_fees_adjusted_quantiles"
...
python manager.py genscen-joinmarket  \
  --name "baseline_makers_9_1_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
...
python manager.py genscen-joinmarket  \
  --name "makers_5_1_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
python manager.py genscen-joinmarket  \
  --name "makers_7_1_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
python manager.py genscen-joinmarket  \
  --name "makers_9_3_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
python manager.py genscen-joinmarket  \
  --name "makers_11_1_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
python manager.py genscen-joinmarket  \
  --name "makers_13_2_utxos_10_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
# 7. UTXO COUNT 3
python manager.py genscen-joinmarket  \
  --name "makers_9_1_utxos_3_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
# 8. UTXO COUNT 5
python manager.py genscen-joinmarket  \
  --name "makers_9_1_utxos_5_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
...
# 9. UTXO COUNT 15
python manager.py genscen-joinmarket  \
  --name "makers_9_1_utxos_15_quantiles" \
  --maker-count 160 \
  --relative-makers 80 \
  --tumbler-taker-count 8 \
  --taker-count 0 \
